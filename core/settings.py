...
if not DEBUG:
    ...
    DEFAULT_FROM_EMAIL = 'BoomSlag - Ecommerce Platform <admin@fesamedcare.awsapps.com>'
    ...
    # django-ckeditor will not work with S3 through django-storages without this setting
