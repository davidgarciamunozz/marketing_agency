function Testimonial (){
    return (
        <div className="bg-white pt-16 lg:py-32 lg:pb-40">
      <div className="bg-gray-50 pb-16 lg:relative lg:z-10 lg:pb-0">
        <div className="lg:mx-24 lg:grid lg:max-w-full lg:grid-cols-3 lg:gap-8 lg:px-8">
            ...
            <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 lg:py-20">
              <blockquote>
                ...
                <footer className="mt-6">
                  ...
                  <p className="text-base font-medium text-gray-500">CEO at PureInsights</p>
                </footer>
              </blockquote>
            </div>
          </div>
