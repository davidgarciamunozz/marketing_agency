...
function PositionsList(){
    return(
        <div className="max-w-full mx-4 lg:mx-32 bg-white">
            <h2 className="text-5xl font-semibold text-gray-900 pb-8">Open Positions</h2>
            <p className="text-xl font-regular text-gray-900 max-w-5xl">Let's write some beautiful code and make smart designs. This is what we're crazy about, and we're looking for the ones who feel the same.</p>
      ...
      <ul role="list" className="divide-y divide-gray-200">
        {applications.map((application) => (
          <li key={application.applicant.email}>
            <a href={application.href} className="block hover:bg-gray-50 transition duration-300 ease-in-out">
