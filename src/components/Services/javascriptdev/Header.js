          ...
          <div>
            <div>
              ...
              <p className="mt-6 text-xl leading-8 text-gray-900 ">
                {/* Javascrip development description, call to action */}
                We love to shake things up and create what has never been attempted before. We transform ideas into reality.
              </p>
            </div>
